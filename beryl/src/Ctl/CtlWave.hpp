...
// $Id: CtlWave.hpp 634 2022-11-19 22:52:03Z duncang $
...
// Description        :
/*
  Here we sit at the top.  There are 4 ways to make a beryl signal:
      Simple Apodizer
...
class CtlWave {
  ...
  public:
            ...
            void     SetTypeApSinSinc  ( void        );
            bool     GetTypeApSinSinc  ( void        ) { return sigType == ET_APOD_SIN_SINC    ;};
