...
// $Id: CfgParticles.hpp 572 2021-06-21 00:42:24Z duncang $
...
class CfgParticles {
  ...
  public:
    ...
    Glib::RefPtr<Gdk::Pixbuf> pxbf_logo_at;
    Glib::RefPtr<Gdk::Pixbuf> pxbf_logo_catraeus;
    Glib::RefPtr<Gdk::Pixbuf> pxbf_icon_catraeus;
    ...
    Glib::RefPtr<Gdk::Pixbuf> pxbf_ana_spec;
    Glib::RefPtr<Gdk::Pixbuf> pxbf_ana_scope;
    Glib::RefPtr<Gdk::Pixbuf> pxbf_xprt_start_bright;
    Glib::RefPtr<Gdk::Pixbuf> pxbf_xprt_start_dim;
    Glib::RefPtr<Gdk::Pixbuf> pxbf_xprt_stop_bright;
    Glib::RefPtr<Gdk::Pixbuf> pxbf_xprt_stop_dim;
