...
// $Id: CfgParticles.cpp 506 2019-12-25 15:35:12Z duncang $
...
#include <icon/pn_LED_Grn_On_024.xpm>
#include <icon/pn_LED_Grn_Off_024.xpm>
  ...
  , cols_Caes_BlueDark  ("#101830")
{
  ...
  pxbf_op_fileOpen_bright = Gdk::Pixbuf::create_from_xpm_data(op_file_open_bright_032_xpm);
  pxbf_op_helpAbout       = Gdk::Pixbuf::create_from_xpm_data(op_help_about_032_xpm);
  pxbf_pn_LEDgrnOn        = Gdk::Pixbuf::create_from_xpm_data(pn_LED_Grn_On_024_xpm);
  pxbf_pn_LEDgrnOff       = Gdk::Pixbuf::create_from_xpm_data(pn_LED_Grn_Off_024_xpm);
  }
